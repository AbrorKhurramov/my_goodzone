...
class CustomBouncingWidget extends StatefulWidget {
  ...
  @override
  _CustomBouncingWidgetState createState() => _CustomBouncingWidgetState();
}

class _CustomBouncingWidgetState extends State<CustomBouncingWidget>
...
late  double _scale;
  ...
  @override
  void didUpdateWidget(CustomBouncingWidget oldWidget) {
